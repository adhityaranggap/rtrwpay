...
<head>
    ...
    <title>Login &mdash; RTRW Pay</title>
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <img src="../assets/img/login-logo.png" alt="logo" width="50" class="shadow-light rounded mb-5 mt-2">
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="../assets/img/unsplash/login-bg-city-2.jpg">
